...
function Stibnite_gal_skeleton($post)
{
    ...
    $ret = array();
    $ret["FullSizeImage"] = get_template_directory_uri() . '/img/view-full-size.png';
    $ret["FiTSizeImage"] = get_template_directory_uri() . '/img/fit-to-canvas.png';
    echo json_encode($ret);
}

function Stibnite_gal_info($post)
{
    // header('Content-type: application/json');
    $pid = $post->ID;
    $content = apply_filters('the_content', $post->post_content);
    ...
    $ret = array();
    $ret["FullSizeIcon"] = get_template_directory_uri() . '/img/view-full-size.png';
    $ret["FiTSizeIcon"] = get_template_directory_uri() . '/img/fit-to-canvas.png';
